LoCoin (LCC) - True Location Coin provides GNSS based location service through blockchain.
...
So actually, this 'new' coin exists for the following reasons:
 - LCC proves that really anyone(!) can start a Litecoin/Bitcoin based currency
...
Finally, I only tested the command line server/tool 'locoin' for the
